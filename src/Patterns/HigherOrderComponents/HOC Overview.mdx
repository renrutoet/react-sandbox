...
- Hooks and especially creating your own custom hooks are often a good solution to similar problems however there are some cases where HOC can be a good fit
- You can create Wrapper Components which can be similar but more readable.
...
//TODO expand on these use cases with examples and rewrite in own words
//cases listed from developer way post
Useful Use Cases for the HOC Pattern
